...
2. Users must not engage in intentional command spam, exploit bugs, attempt to gain an unfair advantage, attempt to bypass rate limits, or try to crash, hack, disrupt the operation of Iconoclast, or any other actions we deem to be disruptive.
3. The Iconoclast Team reserves the sole right to suspend, ban, or prohibit any user or server from accessing or using the bot at any time, for any reason, without prior notice.
